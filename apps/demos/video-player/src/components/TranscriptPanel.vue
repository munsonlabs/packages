...
// Big Buck Bunny (CC-BY, Blender Foundation) - long enough for a real transcript to scroll.
...
// Scene markers, not word-level captions - `end` on two of them demos the highlight gap.

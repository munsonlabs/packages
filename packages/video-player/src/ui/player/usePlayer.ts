...
import { createPlayerState, type PlayerState } from '@/ui/player/playerState'
import { useFullscreen } from '@/ui/player/features/useFullscreen'
...
import { mountAdapter, type MountedAdapter } from '@/ui/player/adapterMount'

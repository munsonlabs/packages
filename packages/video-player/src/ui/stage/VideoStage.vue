...
import { registerStage, unregisterStage, stageState } from '@/registries/stageRegistry'
import { PlaylistKey } from '@/ui/player/playerContext'
import { usePinnedBox } from '@/ui/pinned/usePinnedBox'
import { dispatchStageEvent, useStageEvent } from '@/ui/stage/useStageBus'
import { useForwardedPlayer } from '@/ui/player/useForwardedPlayer'
import { usePlaylist } from '@/ui/stage/usePlaylist'
...
import { getAutoAdvance, saveAutoAdvance } from '@/preferences/autoAdvancePreference'
